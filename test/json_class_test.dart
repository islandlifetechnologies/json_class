...
void main() {
  ...
  test('JsonClass.parseDateTime', () {
    expect(JsonClass.maybeParseDateTime(null), null);

    expect(() => JsonClass.parseDateTime(null), throwsException);
    ...
    expect(JsonClass.parseDateTime('01/02/2020'), DateTime(2020, 01, 02));
    expect(JsonClass.parseDateTime('01/02/2020').isUtc, false);

    expect(JsonClass.parseDateTime('2020-02-01'), DateTime(2020, 02, 01));
    expect(JsonClass.parseDateTime('2020-02-01').isUtc, false);

    expect(
      JsonClass.parseDateTime('2020-02-01T12:30'),
      DateTime(2020, 02, 01, 12, 30),
    );
    expect(JsonClass.parseDateTime('2020-02-01T12:30').isUtc, false);

    expect(
      JsonClass.parseDateTime('2020-02-01T12:30:45'),
      DateTime(2020, 02, 01, 12, 30, 45),
    );
    expect(JsonClass.parseDateTime('2020-02-01T12:30:45').isUtc, false);

    expect(
      JsonClass.parseDateTime('2020-02-01T12:30:45.123'),
      DateTime(2020, 02, 01, 12, 30, 45, 123),
    );
    expect(JsonClass.parseDateTime('2020-02-01T12:30:45.123').isUtc, false);

    expect(JsonClass.parseDateTime('2020-02-01T12:30Z').isUtc, true);
    expect(JsonClass.parseDateTime('2020-02-01T12:30:45Z').isUtc, true);
    expect(JsonClass.parseDateTime('2020-02-01T12:30:45.123Z').isUtc, true);

    const millis = 1586717564014;
    expect(JsonClass.parseDateTime(millis).millisecondsSinceEpoch, millis);
    expect(JsonClass.parseDateTime('$millis').millisecondsSinceEpoch, millis);
  ...
  test('JsonClass.parseDouble', () {
    ...
    expect(JsonClass.parseDouble('infinity'), double.infinity);
    expect(JsonClass.parseDouble('INFINITY'), double.infinity);
  ...
  test('JsonClass.parseDoubleList', () {
    ...
    expect(JsonClass.parseDoubleList([1.23, '1.23', '1.0', 1, '0xff']), [
      1.23,
      1.23,
      1.0,
      1.0,
  ...
  test('JsonClass.parseDurationFromMillis', () {
    ...
    expect(
      JsonClass.parseDurationFromMillis(const Duration(milliseconds: 123)),
  ...
  test('JsonClass.parseDurationFromSeconds', () {
    ...
    expect(
      JsonClass.parseDurationFromSeconds(const Duration(seconds: 123)),
  ...
  test('JsonClass.parseIntList', () {
    ...
    expect(JsonClass.parseIntList([1.23, '1.23', '1.0', 1, 0xff]), [
      1,
      1,
      1,
      1,
  ...
  test('JsonClass.parseUtcMillis', () {
    ...
    expect(JsonClass.maybeParseUtcMillis(null), null);
    expect(() => JsonClass.parseUtcMillis(null), throwsException);
  ...
  test('JsonClass.parseValue', () {
    expect(JsonClass.maybeParseValue<DateTime>(null), null);
    expect(() => JsonClass.parseValue<DateTime>(null), throwsException);
    ...
    expect(JsonClass.parseValue<DateTime>('01/02/2020').isUtc, false);

    expect(
      JsonClass.parseValue<DateTime>('2020-02-01'),
      DateTime(2020, 02, 01),
    );
    expect(JsonClass.parseValue<DateTime>('2020-02-01').isUtc, false);

    expect(
      JsonClass.parseValue<DateTime>('2020-02-01T12:30'),
      DateTime(2020, 02, 01, 12, 30),
    );
    expect(JsonClass.parseValue<DateTime>('2020-02-01T12:30').isUtc, false);

    expect(
      JsonClass.parseValue<DateTime>('2020-02-01T12:30:45'),
      DateTime(2020, 02, 01, 12, 30, 45),
    );
    expect(JsonClass.parseValue<DateTime>('2020-02-01T12:30:45').isUtc, false);
    ...
    expect(JsonClass.parseValue<DateTime>('2020-02-01T12:30Z').isUtc, true);
    expect(JsonClass.parseValue<DateTime>('2020-02-01T12:30:45Z').isUtc, true);
    expect(
  ...
  test('JsonClass.removeNull', () {
    ...
    expect(JsonClass.removeNull(data), {'foo': 'bar'});
    expect(JsonClass.removeNull(data, false), {
      'foo': 'bar',
      'list': [],
      'map': {},
    });
